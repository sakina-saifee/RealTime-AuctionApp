...
<div className='name'>
  <label>Name</label>
      <input type="text" placeholder='Your name here..'  name="username" value={userdata.username} onChange={handleChange} />
  </div>
...
<button className='loginBtnForm' onClick={handleSubmit}>Sign up</button>

<div className='createNewaccdiv'>
   
      <Link to='/userlogin' className='alreadyhaveAcc'><p>Already Have an account? Login</p></Link>
</div>
